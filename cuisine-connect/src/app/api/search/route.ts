...
import { findAllRecipes } from "../../actions/recipes";
...
Pour donner le résultat, tu dois te reposer sur l'objet 'recipes' que je te fournis. Donc les résultats doivent appartenir dans l'objet 'recipes' donné. Tu peut utilises les champs 'keywords' et 'title' pour filtrer les recettes en fonction de la recherche de l'utilisateur.\
